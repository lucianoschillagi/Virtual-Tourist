...
//		}
		...
		// precargar los datos persistidos, por ahora sólo los pines
//		let pinsPersistidos = Pin(latitude: self.pinsPersistidos.latitude, longitude: self.pinsPersistidos.longitude, context: stack.context)
